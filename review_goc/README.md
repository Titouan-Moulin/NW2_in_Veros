# DINO configuration in VEROS
This repository provides configuration files and a script to generate the Figure 7 of the manuscript Roquet et al. 2025. *Controls of the Global Overturning Circulation of the Oceans*, submitted to npj Atmosphere and Climate Science.

## Instructions:
  1. Install the model VEROS [Hafner et al., 2018] following this [instruction](https://veros.readthedocs.io/en/latest/introduction/get-started.html) 
  2. Copy the configuration files (.py files in this repository, note that other configurations are available in [setups](https://github.com/Titouan-Moulin/NW2_in_Veros/tree/main/setups) )
